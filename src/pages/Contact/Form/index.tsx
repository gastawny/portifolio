            ...
            <div className="container">
              ...
              <div className="row100">
                <div className="col">
                  <div className="inputBox">
                    <input
                      value={datas.name}
                      onChange={(event) => inputChange('name', event)}
                      type="text"
                      name=""
                      required
                    />
                ...
                <div className="col">
                  <div className="inputBox">
                    <input
                      value={datas.email}
                      onChange={(event) => inputChange('email', event)}
                      type="text"
                      name=""
                      required
                    />
              ...
              <div className="row100">
                <div className="col">
                  <div className="inputBox textarea">
                    <textarea
                      value={datas.text}
                      onChange={(event) => inputChange('text', event)}
                      required
                    ></textarea>
              ...
              <div className="row100">
                <div className="col">
                  ...
                  <span ref={messageSent} className="message">
                    Message sent
                  </span>
                  <span ref={messageUnset} className="message">
                    Message unset
                  </span>
                </div>
              </div>
